      ...
      <Container maxWidth="xl">
        <Box textAlign="center" mb={8}>
          ...
          >
            ...
            >
              Serving all over India with extensive coverage in 2nd & 3rd tier cities
            </Typography>
          </motion.div>
        </Box>
            ...
            <Grid container spacing={3} alignItems="center">
              <Grid item xs={12} md={8}>
                ...
                <Typography variant="body1" sx={{ color: 'text.secondary', mb: 2 }}>
                  We pride ourselves on serving not just metro cities but also extensive coverage 
                  in 2nd and 3rd tier cities across India. Our network includes:
                </Typography>
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                  {['Nagpur', 'Indore', 'Vadodara', 'Coimbatore', 'Visakhapatnam', 'Kochi', 'Guwahati', 'Bhubaneswar', 'Dehradun', 'Surat'].map((city, index) => (
                    <Chip
                      key={index}
                      label={city}
                      size="small"
